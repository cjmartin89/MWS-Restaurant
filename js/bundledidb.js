...
var obStore = 'restaurants';

var dbPromise = _idb2.default.open("mws-restaurant", 1, function (upgradeDB) {
        ...
        switch (_context.prev = _context.next) {
          ...
          case 7:
            ...
            restaurants.forEach(function (restaurant) {
              return db.transaction(obStore, 'readwrite').objectStore(obStore).put(restaurant);
            });

          case 10:
            return _context.abrupt("return", restaurants);
...
dbPromise.then(function (db) {
  if (db) {
    ...
    tx.objectStore(obStore).getAll;
  }

  return [];
});

},{"babel-polyfill":2,"idb":328}],2:[function(require,module,exports){
(function (global){
"use strict";
